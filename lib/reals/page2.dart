...
class _VideoPage2State extends State<VideoPage2> {
  ...
  void initState() {
    ...
    // or the internet.
    _controller = VideoPlayerController.asset(widget.imageLink.videos[1]);
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          RealScreen(
            profileName: widget.texts.profileName[1],
            profileImage: widget.imageLink.profileImages[1],
            caption: widget.realText.descriptions[1],
            like: widget.realText.likes[1],
            comment: widget.realText.comments[1],
            share: widget.realText.shares[1],
            imageSound: widget.imageLink.profileImages[1],
          )
        ],
      ),
    );
