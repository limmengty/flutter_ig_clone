...
class VideoPage7 extends StatefulWidget {
  final AllImageLink imageLink = AllImageLink();
  final Texts texts = Texts();
  final RealText realText = RealText();
  VideoPage7({super.key});

  @override
  State<VideoPage7> createState() => _VideoPage7State();
}

class _VideoPage7State extends State<VideoPage7> {
  ...
  void initState() {
    ...
    // or the internet.
    _controller = VideoPlayerController.asset(widget.imageLink.videos[6]);
